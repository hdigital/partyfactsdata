...
1. `/workspaces/partyfactsdata/codemeta.json` (CodeMeta 3.0)
2. `/workspaces/partyfactsdata/CITATION.cff` (CFF 1.2.0)
3. `/workspaces/partyfactsdata/README.md`
4. `/workspaces/partyfactsdata/LICENSE.md`
5. `/workspaces/partyfactsdata/CHANGELOG.md`
6. `/workspaces/partyfactsdata/codebook/codebook.Rmd`
...
2. **Dataverse:** Bederke, Döring & Regel. 2019. Harvard Dataverse
...
```bash
# Project URLs
curl -4 -I http://partyfacts.org  # Expect: 301 → https://partyfacts.herokuapp.com
...
curl -I https://dataverse.harvard.edu/dataverse/partyfacts  # Expect: 202
...
**Status codes:** 200=OK, 202=Accepted, 301/302=Redirect, 303=See Other, 403=Forbidden (may be bot blocking), 404=Not Found (ERROR)

**Troubleshooting:** Use `-4` for IPv4, `-L` to follow redirects, test 403s manually in browser
...
- Missing ORCIDs for Bederke and Döring
- License mismatches
